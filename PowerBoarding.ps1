function Main-Menu 
{
    do
    {
        Clear
        Write-Host "
 _______  _______  _     _  _______  ______    ___      _______  _______  ______   _______  ______   
|       ||       || | _ | ||       ||    _ |  |   |    |       ||   _   ||      | |       ||    _ |  
|    _  ||   _   || || || ||    ___||   | ||  |   |    |   _   ||  |_|  ||  _    ||    ___||   | ||  
|   |_| ||  | |  ||       ||   |___ |   |_||_ |   |    |  | |  ||       || | |   ||   |___ |   |_||_ 
|    ___||  |_|  ||       ||    ___||    __  ||   |___ |  |_|  ||       || |_|   ||    ___||    __  |
|   |    |       ||   _   ||   |___ |   |  | ||       ||       ||   _   ||       ||   |___ |   |  | |
|___|    |_______||__| |__||_______||___|  |_||_______||_______||__| |__||______| |_______||___|  |_|
"
        Write-Host "- - - - - -"
        Write-Host "Welcome to Powerloader"
        Write-Host "- - - - - -"
